...
\noindent\textbf{Phase 1: Donor Registry and MCEF Implementation}
...
\begin{lstlisting}[language=TypeScript, caption={Firestore DonorProfile document structure}]
{
...
\noindent\textbf{Phase 2: Blood Request, NLP Triage, and GMA Implementation}
...
\begin{lstlisting}[language=TypeScript, caption={NLP urgency lexicon (excerpt)}]
...
\noindent\textbf{Phase 3: ZICP Forecasting Engine Implementation}
...
\noindent The following code listings present representative excerpts from the K9Hope source repository (\url{https://github.com/Rvunveil/k9hope-canine-blood-donation}). Five listings are provided, covering the functional areas of the platform: (A1) authentication middleware and role-based routing, (A2) user login and role-differentiated database initialisation, (A3) donor eligibility and urgent request retrieval, (A4) Haversine geospatial distance computation and GMA query, and (A5) the ZICP training, calibration, and inference pipeline. All listings are drawn from production source files; minor inline comments have been added for report readability.

\noindent\textbf{Listing A1: Authentication Middleware and Role-Based Route Protection}
(\texttt{middleware.ts})
...
\noindent\textbf{Listing A2: User Login and Role-Differentiated Database Initialisation}
...
\noindent\textbf{Listing A3: Urgent Request Retrieval with Blood-Type and City Matching}
...
\noindent\textbf{Listing A4: Haversine Geospatial Distance Computation and GMA Donor Shortlist}
...
\noindent\textbf{Listing A5: ZICP Training, Calibration, and Inference Pipeline}
